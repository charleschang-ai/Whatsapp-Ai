{
    ...
    'summary': """Meta Whatsapp chat all in one integrated with the sale purchase accounting discuss modules. all in one whatsapp can help you to take the advantage of the whatsapp communication in current market
        ...
        Odoo V19Enterprise Edition
        Odoo V19 Enterprise Edition WhatsApp Integration
        V19 Enterprise Edition WhatsApp
        Enterprise Edition WhatsApp
        Enterprise Edition
        WhatsApp Enterprise Edition
        Odoo WhatsApp Enterprise Edition
        Odoo WhatsApp Cloud API
        WhatsApp Cloud API
        WhatsApp Enterprise Edition ,
        AI WhatsApp Chatbot, OpenAI, RAG AI, Official WhatsApp Cloud API, Meta, Odoo V19, Odoo Enterprise Edition, AI Integration, 
    ...
    'description': """
        ...
        Odoo V19Enterprise Edition WhatsApp Integration
        V19 Enterprise Edition WhatsApp
        Enterprise Edition WhatsApp
        Enterprise Edition
        WhatsApp Enterprise Edition
